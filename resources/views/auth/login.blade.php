...
<style>
    ...
    .input-focus-effect:focus { transform: translateY(-2px); box-shadow: 0 4px 12px rgba(192, 38, 211, 0.2); }
    .btn-hover { transition: all 0.3s ease; }
    .btn-hover:hover { transform: translateY(-3px); box-shadow: 0 8px 20px rgba(192, 38, 211, 0.4); }
    .logo-glow { filter: drop-shadow(0 0 20px rgba(255, 255, 255, 0.3)); }
</style>

<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-fuchsia-600 via-fuchsia-500 to-pink-400 p-4">
    ...
    <div class="w-full max-w-4xl min-h-[520px] flex rounded-3xl overflow-hidden shadow-2xl bg-white animate-fadeIn">
        ...
        <div class="w-full lg:w-1/2 p-6 lg:p-8 flex flex-col justify-center">
            ...
            <div class="mb-6 flex justify-center animate-slideInLeft">
                <img src="{{ asset('images/logo-dynasty-1.png') }}" alt="Dynasty Logo" class="w-28 h-28 object-contain">
            </div>
            ...
            <form method="POST" action="{{ route('login.post') }}" class="space-y-4">
                ...
                <div class="flex items-center justify-between animate-fadeInUp delay-500">
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" name="remember" class="w-4 h-4 text-fuchsia-600 border-gray-300 rounded focus:ring-fuchsia-500">
                ...
                <div class="pt-2 animate-fadeInUp delay-500">
                    <button type="submit" class="w-full py-3 bg-gradient-to-r from-fuchsia-600 via-fuchsia-500 to-pink-500 text-white font-semibold rounded-xl btn-hover shadow-lg">
